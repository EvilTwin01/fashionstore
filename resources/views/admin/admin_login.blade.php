...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('backend_backend_assets/demo/favicon.png') }}">
...
<body class="body-bg-full profile-page" style="background-image: url({{ asset('backend_assets/img/site-bg.jpg)') }}">
    <div id="wrapper" class="row wrapper">
        <div class="container-min-full-height d-flex justify-content-center align-items-center">
            <div class="login-center">
                <div class="navbar-header text-center mt-2 mb-4">
                    <a href="index.html">
                        <img alt="" src="{{ asset('backend_assets/img/logo-dark.png') }}">
                    </a>
                </div>
                <!-- /.navbar-header -->
            <form method="POST" action="{{ url('admin') }}">{{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <input type="email" placeholder="johndoe@site.com" class="form-control form-control-line" name="email" id="example-email">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button class="btn btn-block btn-lg btn-primary text-uppercase fs-12 fw-600" type="submit" value="Login">Login</button>
                    </div>
    ...
    <script src="{{ asset('backend_assets/js/material-design.js') }}"></script>
</body>
