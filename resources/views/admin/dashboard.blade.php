        ...
        <div class="widget-holder widget-sm col-md-3 widget-full-height">
            <div class="widget-bg">
                <div class="widget-body">
                    <div class="counter-w-info media">
                        <div class="media-body">
                            <p class="text-muted mr-b-5">Monthly Revenue</p><span class="counter-title color-pink">&dollar;<span class="counter">9470</span> </span>
                            <!-- /.counter-title -->
                    ...
                    <div class="widget-user-activities-2 fs-13">
                        ...
                        <div class="single"><a href="#" class="btn btn-xs btn-rounded btn-pink text-uppercase fw-bold fs-11 px-3 mx-2">Message</a>
                            <figure class="thumb-xxs mr-b-0 mx-2">
                                <a href="#">
                                    <img src="{{ asset('backend_assets/demo/users/user2.jpg') }}" class="rounded-circle" alt="User 1">
                                </a>
                            </figure>
                        ...
                        <div class="single"><a href="#" class="btn btn-xs btn-rounded btn-info text-uppercase fw-bold fs-11 px-3 mx-2">Reminder</a>
                            <div class="user-avatar-list">
                                <a href="#" class="thumb-xxs">
                                    <img src="{{ asset('backend_assets/demo/users/user4.jpg') }}" class="rounded-circle" alt="User 4">
                                </a>
                                <a href="#" class="thumb-xxs">
                                    <img src="{{ asset('backend_assets/demo/users/user3.jpg') }}" class="rounded-circle" alt="User 3">
                                </a>
                                <a href="#" class="thumb-xxs">
                                    <img src="{{ asset('backend_assets/demo/users/user2.jpg') }}" class="rounded-circle" alt="User 2">
                                </a>
                            </div>
                        ...
                        <div class="single"><a href="#" class="btn btn-xs btn-rounded btn-pink text-uppercase fw-bold fs-11 px-3 mx-2">Message</a>
                            <figure class="thumb-xxs mr-b-0 mx-2">
                                <a href="#">
                                    <img src="{{ asset('backend_assets/demo/users/user6.jpg') }}" class="rounded-circle" alt="User 1">
                                </a>
                            </figure>
                        ...
                        <div class="single"><a href="#" class="btn btn-xs btn-rounded btn-success text-uppercase fw-bold fs-11 px-3 mx-2">Files</a>
                            ...
                            <figure class="thumb-xxs mr-b-0 mx-2">
                                <a href="#">
                                    <img src="{{ asset('backend_assets/demo/blog-post-1-thumb.jpg') }}" class="rounded-circle" alt="User 1">
                                </a>
                            </figure>
                    ...
                    <div class="widget-latest-posts-2">
                        <article class="post post-gallery">
                            <div class="gallery lightbox-gallery row" data-toggle="lightbox-gallery" data-type="image">
                                <div class="col-6">
                                    <a href="{{ asset('backend_assets/demo/carousel/carousel-1.jpg') }}" class="post-img lightbox d-block mr-b-5">
                                        <img src="{{ asset('backend_assets/demo/carousel/carousel-1-thumb.jpg') }}" alt="A book is a dream that you hold in your hands">
                                    </a>
                                </div>
                                <!-- /.col-6 -->
                                <div class="col-6">
                                    <a href="{{ asset('backend_assets/demo/carousel/carousel-2.jpg') }}" class="post-img lightbox d-block mr-b-5">
                                        <img src="{{ asset('backend_assets/demo/carousel/carousel-2-thumb.jpg') }}" alt="A book is a dream that you hold in your hands">
                                    </a>
                                    <a href="{{ asset('backend_assets/demo/carousel/carousel-3.jpg') }}" class="post-img lightbox d-block mr-b-5">
                                        <img src="{{ asset('backend_assets/demo/carousel/carousel-3-thumb.jpg') }}" alt="A book is a dream that you hold in your hands">
                                    </a>
                                </div>
                                <!-- /.col-6 -->
                            </div>
                            ...
                            <div class="post-details">
                                ...
                                <div class="post-links">
                                    <figure>
                                        <a href="#">
                                            <img class="rounded-circle" src="{{ asset('backend_assets/demo/users/user1.jpg') }}" alt="User 1">
                                        </a>
                                    </figure>
                                    <ul>
                    ...
                    <div class="widget-todo">
                        ...
                        <div class="single media"><i class="single-icon feather feather-circle color-info"></i>
                            ...
                            <div class="user-avatar-list align-self-center mr-3 mr-0-rtl ml-3-rtl"><a href="#" class="btn btn-circle btn-sm btn-white fw-bold more-link">+</a> 
                                ...
                                <a href="#" class="thumb-xxs">
                                    <img src="{{ asset('backend_assets/demo/users/user5.jpg') }}" class="rounded-circle" alt="User 5">
                                </a>
                            </div>
                            <!-- /.user-avatar-list -->
                            <div class="dropdown align-self-center"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="feather feather-more-vertical"></i></a>
                        ...
                        <div class="single media"><i class="single-icon feather feather-circle color-success"></i>
                            ...
                            <div class="user-avatar-list align-self-center mr-3 mr-0-rtl ml-3-rtl">
                                <a href="#" class="thumb-xxs">
                                    <img src="{{ asset('backend_assets/demo/users/user5.jpg') }}" class="rounded-circle" alt="User 2">
                                </a>
                            </div>
                            <!-- /.user-avatar-list -->
                            <div class="dropdown align-self-center"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="feather feather-more-vertical"></i></a>
