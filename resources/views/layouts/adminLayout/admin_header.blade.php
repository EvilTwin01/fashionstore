    ...
    <nav class="navbar">
        ...
        <div class="navbar-header">
            <a href="index.html" class="navbar-brand">
                <img class="logo-expand" alt="" src="{{ asset('backend_assets/img/logo-dark.png') }}">
                <img class="logo-collapse" alt="" src="{{ asset('backend_assets/img/logo-collapse.png') }}">
                <!-- <p>BonVue</p> -->
            </a>
        </div>
        <!-- /.navbar-header -->
                ...
                <div class="dropdown-menu dropdown-left dropdown-card dropdown-card-dark animated flipInY">
                    <div class="card">
                        ...
                        <ul class="card-body list-unstyled dropdown-list-group">
                            ...
                            <li><a href="#" class="media"><span class="d-flex thumb-xs user--online"><img src="{{ asset('backend_assets/demo/users/user3.jpg') }}" class="rounded-circle" alt=""> </span><span class="media-body"><span class="heading-font-family media-heading">Steve Smith</span> <span class="media-content">I slowly updated projects</span></span></a>
                            </li>
        ...
        <ul class="nav navbar-nav">
            <li class="dropdown"><a href="javascript:void(0);" class="dropdown-toggle dropdown-toggle-user ripple" data-toggle="dropdown"><span class="avatar thumb-xs2"><img src="{{ asset('backend_assets/demo/users/user1.jpg') }}" class="rounded-circle" alt=""> <i class="feather feather-chevron-down list-icon"></i></span></a>
                <div
